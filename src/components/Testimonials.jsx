...
const TestimonialData = [{
    id: 1,
    name: "Angad",
    text: "A strong and rich coffee made by forcing hot water through finely ground coffee beans.Perfect for a bold flavor and instant energy.",
    img: "https://picsum.photos/101/101",
},
{
    id: 2,
    name: "Rohit",
    text: "A smooth coffee prepared by adding hot water to espresso.Light, balanced, and easy to enjoy anytime.",
    img: "https://picsum.photos/102/102",
},
{
    id: 3,
    name: "Ranjeet",
    text: "A classic blend of espresso, steamed milk, and thick milk foam.Creamy texture with a rich and satisfying taste.",
