...
const MenuData = [
    {
      ...
      name: "Espresso",
      description:
        "A classic blend of espresso, steamed milk, and thick milk foam.Creamy texture with a rich and satisfying taste.",
    },
    {
      id: 2,
      img: Img1,
                ...
                <div className='rounded-2xl bg-white hover:bg-amber-900 transition-all hover:text-white relative shadow-xl duration-high group max-w-[300px]'>
                    ...
                    <div className='p-4 text-center'>
                        ...
                        <div className='flex justify-between mt-5 px-6 items-center'>
                            <p className='text-lg font-semibold'>Rs399.75</p>
